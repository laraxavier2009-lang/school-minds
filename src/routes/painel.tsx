...
function PainelPage() {
  ...
  return (
    <main className="px-5 pt-6 pb-12 space-y-5">
      ...
      <section
        ...
        style={{ boxShadow: "0 2px 12px rgba(27, 108, 168, 0.08)" }}
      >
              ...
              <div key={t} className="flex items-center gap-2 text-xs">
                ...
                <div className="h-3 flex-1 overflow-hidden rounded-full bg-[var(--cor-fundo)]">
                  <div
                    ...
                    style={{ width: `${pct}%`, background: "var(--cor-primaria)" }}
                  />
                </div>
            ...
            {alertas.map((a) => {
              ...
              return (
                <li
                  key={a.id}
                  className="px-4 py-3"
                  style={{ background: grave ? "#FFEBEE" : "transparent" }}
                >
